...
This vignette demonstrates the advanced features of Athlytics for endurance training analysis:
...
Traditional ACWR uses rolling averages (RA). The EWMA method, introduced by Williams et al. (2017), offers:
...
> **Reference:** Williams, S., et al. (2017). Better way to determine the acute:chronic workload ratio? *British Journal of Sports Medicine*, 51(3), 209-210. [DOI: 10.1136/bjsports-2016-096589](https://doi.org/10.1136/bjsports-2016-096589)
...
1. Daily load sequence is resampled in overlapping weekly blocks (preserves within-week correlation)
